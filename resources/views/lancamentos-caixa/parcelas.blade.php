...
<div class="container">
    ...
    <form action="{{ route('parcelas.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" name="valorT" class="form-control" step="0.01" required>
        </div>
        <div class="form-group">
            <label for="valorE">Valor Entrada:</label>
            <input type="number" name="valorE" class="form-control" step="0.01" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" name="parcelas" class="form-control" step="1" min="1" value="1" required>
        </div>
        <div class="form-group">
